...
namespace figures
{
    ...
    protected:
        ...
        std::string getAnglesInfo() override {
            return Figure::getAnglesInfo() + "A = " + std::to_string(getA()) + " B = " + std::to_string(getB()) + " C = " + std::to_string(getC());
        }

        std::string getSidesInfo() override {
            return Figure::getSidesInfo() + "a = " + std::to_string(geta()) + " b = " + std::to_string(getb()) + " c = " + std::to_string(getc());
        }
